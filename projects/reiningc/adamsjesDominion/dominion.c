...
void adventurerF(int drawnTreasure, struct gameState *state, int currentPlayer, int cardDrawn, int tempHand[], int handPos);
...
void adventurerF(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int temphand[], int handPos){
      int z = 0;
      while(drawntreasure<2){ //bug added should be drawn treasure < 2
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerF(drawntreasure, state, currentPlayer, cardDrawn, temphand, handPos);	
      return 0;
